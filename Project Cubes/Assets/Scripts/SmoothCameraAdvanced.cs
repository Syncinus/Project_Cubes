...
public abstract class UnityObject : MonoBehaviour 
{
	...
	public Renderer Renderer
	{
		get
		{
			...
			if (ourRenderer == null)
			{
				Transform myRootChild = Transform.Find("Root");
				if(myRootChild != null)
...
public class DetectionTrigger : MonoBehaviour
{
	...
	private List<System.Type> ourIgnoreTypes = new List<System.Type>();
	public List<System.Type> IgnoreTypes
	{
...
public class SmoothCameraAdvanced : MonoBehaviour {
	#region Private Properties
	...
	private bool targetRegistered = false;
