...
namespace Chronos
{
	public class RewindableParticleSystemTimeline : ComponentTimeline<ParticleSystem>, IParticleSystemTimeline
	{
		...
		public override void CopyProperties(ParticleSystem source)
		{
			...
			enableEmissionOnStart = _enableEmission = source.enableEmission;
		...
		public override void Update()
		{
			...
			{
				component.enableEmission = enableEmissionOnStart;
				...
				for (int i = 0; i < emissionEvents.Count; i++)
				{
					...
					component.enableEmission = current.action == EmissionAction.Play || current.action == EmissionAction.EnableEmission;
